================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: CardsAgainstHumanityCreator-Projektübersicht
===============================================================================

Diese CardsAgainstHumanityCreator-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CardsAgainstHumanityCreator-Anwendung besteht.

CardsAgainstHumanityCreator.vcxproj
...
CardsAgainstHumanityCreator.vcxproj.filters
...
CardsAgainstHumanityCreator.h
    Dies ist die Hauptheaderdatei für die Anwendung.
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CCardsAgainstHumanityCreatorApp-Anwendungsklasse.

CardsAgainstHumanityCreator.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CCardsAgainstHumanityCreatorApp enthält.

CardsAgainstHumanityCreator.rc
...
res\CardsAgainstHumanityCreator.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei CardsAgainstHumanityCreator.rc enthalten.

res\CardsAgainstHumanityCreator.rc2
...
CardsAgainstHumanityCreatorDlg.h, CardsAgainstHumanityCreatorDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CCardsAgainstHumanityCreatorDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in CardsAgainstHumanityCreator.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CardsAgainstHumanityCreator.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
...
CardsAgainstHumanityCreator.manifest
